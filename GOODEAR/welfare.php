		...
		function initMap() {
		 ...
		 /* window.onload=function() { */
		     ...
		     var ripLen=xmlData.getElementsByTagName("District").length;
		      		...
		      		for (var i=0 ; i<ripLen ; i++) {
				      	/*--------check_district--------*/
					        ...
					        if (d <= tmpd) {
		        				...
		        				getobject=xmlData.getElementsByTagName("Object")[i].firstChild.nodeValue;
		        				getservice=xmlData.getElementsByTagName("Service")[i].firstChild.nodeValue;
					        }
					      ...
					      '</div>';
					        ...
					        var image = 'css/images/welfare_icon.png';
		      ...
		      "<a href='https://www.diyi.org.tw/service/index/3/Early-Intervention-01' style='font-family: 微軟正黑體; font-weight: bold; color:black;'>"+
		      xmlData.getElementsByTagName("Name")[i].firstChild.nodeValue+
		      "</a></br>"+
		      '</h1>'+
		      "<div id='bodyContent' style='font-family: 微軟正黑體;'>"+
		      '<p>屬性：'+xmlData.getElementsByTagName("Religion")[i].firstChild.nodeValue+'</p>'+
		      ...
		      '<p>服務項目：'+xmlData.getElementsByTagName("Service")[i].firstChild.nodeValue+'</p>'+
		      '<p>服務對象：'+xmlData.getElementsByTagName("Object")[i].firstChild.nodeValue+'</p>'+
		      '</div>'+
		      '</div>';
