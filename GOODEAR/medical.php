		...
		function initMap() {
		 ...
		 /* window.onload=function() { */
		     ...
		     var ripLen=xmlData.getElementsByTagName("District").length;
		      ...
		      if (yourDistrict !== "NA" && yourAddress !== "NA") {
		        	...
		        	var getdistrict="";
		      		...
		      		for (var i=0 ; i<ripLen ; i++) {
					      ...
					      '<p>區域：'+getdistrict+'</p>'+
					      '<p>地址：'+getaddress+'</p>'+
					      '<p>電話：0'+getreligion+'-'+gettel+'</p>'+
					      '</div>'+
					      '</div>';

					        var image = 'css/images/medical_icon.png';
		      ...
		      "<a href='http://www.kmch.org.tw/ShowNetRegDept.asp' style='font-family: 微軟正黑體; font-weight: bold; color:black;'>"+
		      ...
		      '<p>電話：0'+xmlData.getElementsByTagName("Religion")[i].firstChild.nodeValue+'-'+xmlData.getElementsByTagName("Tel")[i].firstChild.nodeValue+'</p>'+
		      '</div>'+
		      '</div>';
