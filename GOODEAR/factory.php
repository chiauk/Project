		...
		function initMap() {
		 ...
		 /* window.onload=function() { */
		     ...
		     var ripLen=xmlData.getElementsByTagName("District").length;
		        	...
		        	var getdistrict="";
		      		...
		      		for (var i=0 ; i<ripLen ; i++) {
					      ...
					      '</div>';
					        ...
					        var image = 'css/images/factory_icon.png';
		      ...
		      "<a href='https://www.104.com.tw/jobbank/custjob/index.php?r=cust&j=3c3a446e346c3f6738423c1d1d1d1d5f2443a363189j99' style='font-family: 微軟正黑體; font-weight: bold; color:black;'>"+
		      ...
		      '<p>營業項目：'+xmlData.getElementsByTagName("Religion")[i].firstChild.nodeValue+'</p>'+
		      '</div>'+
		      '</div>';
